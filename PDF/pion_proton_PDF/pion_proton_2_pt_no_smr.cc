...
int main(int argc, char **argv)
{
 ...
 //loop over source position
    ...
    pion_file.open("pion_2pt_no_smr.h5", HDF5Base::ate);
    pion_file.set_stripesize(1048576); // MAGIC NUMBER ALERT!  1048576 = 1024^2 = 1MB.

    HDF5Writer proton_file;
    proton_file.open("proton_2pt_no_smr.h5", HDF5Base::ate);
    ...
    catch (const string &e)
    {
      ...
      QDP_abort(1);
          ...
          LatticePropagator anti_quark_prpgtr = Gamma(15) * quark_prpgtr * Gamma(15);
            ...
            hdf_multi1d_cmplx_wrt_F(pion_file,"TwoPnt_pnt_src_snk",t_lngth,pion_TwoPnt_pnt_snk_fftd);
             
//--3push           
            hdf_multi1d_cmplx_wrt_F(proton_file,"TwoPnt_pnt_src_snk_1",t_lngth,proton_TwoPnt_pnt_snk_1_fftd);
            
            hdf_multi1d_cmplx_wrt_F(proton_file,"TwoPnt_pnt_src_snk_2",t_lngth,proton_TwoPnt_pnt_snk_2_fftd);
